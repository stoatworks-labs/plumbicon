...
/**
    ...
    `FF_FAIL` because one of the shaders would not compile. From the
    operator's side that looks like "the effect does nothing", with no message
    anywhere -- and with several passes it also records *which* one, which is the
