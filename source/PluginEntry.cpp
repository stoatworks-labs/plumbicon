/**
    ...
    `CFFGLPluginInfo` that Plumbicon.cpp registers at static-initialisation
    ...
    binary: which build it is.
        ...
        strings Plumbicon.bundle/Contents/MacOS/Plumbicon | grep plumbicon
*/

extern "C" const char* PlumbiconBuildStamp()
{
	return "plumbicon " PLUMBICON_VERSION " built " __DATE__ " " __TIME__;
}
